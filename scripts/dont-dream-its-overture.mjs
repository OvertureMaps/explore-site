...
const SCHEMA_OUT = path.join(MAP_DIR, "theme/schema.json");
const TILES_OUT = path.join(MAP_DIR, "theme/tiles.json");
const STYLE_DIR = path.join(MAP_DIR, "theme");
const REPORT_OUT = path.join(MAP_DIR, "theme/STYLE-AUDIT.md");
